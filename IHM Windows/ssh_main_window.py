...
class SSHMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.btn_mode_auto = QPushButton("Automatique (Deplacement_Automatique.py)")
        ...
        self.btn_mode_manual = QPushButton("Manuel (Deplacement_Manuel.py)")
    ...
    def launch_autonomous_mode(self):
        """Lance le mode automatique (Deplacement_Automatique.py)"""
    ...
    def launch_manual_mode(self):
        """Lance le mode manuel (Deplacement_Manuel.py)"""
        if self.ssh_client.connected:
